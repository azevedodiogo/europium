...
<!-- Cartões com os indicadores resumidos dos dois países escolhidos. -->
<template>
      ...
      <div class="cp-card__metrics">
        ...
        <div class="cp-card__metric">
          ...
          <div class="cp-progress-wrap">
            ...
            <div class="cp-progress-track"><div class="cp-progress-fill" :style="{ width: dataA.progress + '%' }" /></div>
      ...
      <div class="cp-card__metrics">
        ...
        <div class="cp-card__metric">
          ...
          <div class="cp-progress-wrap">
            ...
            <div class="cp-progress-track"><div class="cp-progress-fill" :style="{ width: dataB.progress + '%' }" /></div>
...
.cp-card__metrics:last-child { margin-bottom: 0; }


.cp-card__metric-label { font-size: var(--text-sm); color: var(--color-text-secondary); margin-bottom: 4px; }

.cp-card__metric-value { font-size: 18px; font-weight: 600; color: var(--color-text-primary); }


/* Barra de progresso visual. */
.cp-progress-wrap { display: flex; align-items: center; gap: 10px; margin-top: 6px; }
.cp-progress-track {
  flex: 1;
  height: 6px;
  
  background: rgba(29,69,135,.2);
...
.cp-progress-pct { font-size: var(--text-base); font-weight: 500; color: var(--color-text-primary); white-space: nowrap; }
