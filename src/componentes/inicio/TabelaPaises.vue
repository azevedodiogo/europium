        ...
        >
          ...
          <td class="countries-table__td">
            ...
            <div class="progress-cell">
              ...
              <div class="progress-cell__bar" role="progressbar" :aria-valuenow="country.progress" aria-valuemin="0" aria-valuemax="100">
...
const sortedCountries = computed(() => {
  return [...countries.value].sort((a, b) => {
    ...
    return typeof aVal === 'string'
      ? aVal.localeCompare(bVal, 'pt') * dir
      : (aVal - bVal) * dir
  })
})
</script>
