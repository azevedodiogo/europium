  ...
  <div class="mm__stats-card">
    ...
    <div class="mm__stats-bars">
      <div class="mm__stat-block">
        ...
        <div class="mm__stat-bar">
          <div class="mm__stat-fill mm__stat-fill--green" :style="{ width: stats.cumpridos.pct + '%' }" />
        </div>
      ...
      <div class="mm__stat-block">
        ...
        <div class="mm__stat-bar">
          <div class="mm__stat-fill mm__stat-fill--orange" :style="{ width: stats.parciais.pct + '%' }" />
        </div>
      ...
      <div class="mm__stat-block">
        ...
        <div class="mm__stat-bar">
          <div class="mm__stat-fill mm__stat-fill--red" :style="{ width: stats.naoCumpridos.pct + '%' }" />
        </div>
