...
export const glossaryData = {
  ...
  terms: [
    ...
    },
    {
      ...
      definition:
        'Pagamento efetivo realizado pela Comissão Europeia a um Estado-Membro após verificação do cumprimento satisfatório dos marcos e metas acordados. Os disbursements dividem-se em pré-financiamento (automático, no início) e pagamentos intercalares/finais (condicionados ao cumprimento de compromissos).',
    ...
    },
    {
      ...
      short: '14 indicators de reporte obrigatório para todos os Estados-Membros.',
      definition:
        'Conjunto de 14 indicators definidos pela Comissão Europeia que todos os Estados-Membros devem reportar semestralmente, independentemente do conteúdo dos seus PRR. Cobrem áreas como energia renovável, eficiência energética, digitalização, educação, emprego e saúde, permitindo comparações entre países.',
    ...
    },
    {
      ...
      definition:
        'Forma de contratação em que uma entidade pública e uma ou more entidades privadas colaboram para realizar um projeto de interesse público. No contexto do PRR, as PPPs são permitidas em determinadas condições e devem respeitar as regras de contratação pública e as disposições específicas do Regulamento MRR.',
      category: 'Execução',
