...
export const timelineData = {
  ...
  events: [
    ...
    },
    {
      ...
      description:
        'A Comissão emite avaliações positivas e o Conselho aprova formalmente os primeiros planos. Espanha, Itália, França, Alemanha, Grécia e mais 12 países recebem luz verde na primeira vaga.',
      impact:
    ...
    },
    {
      ...
      description:
        'Os desembolsos aceleram significativamente. Itália, Espanha e outros grandes beneficiários recebem múltiplos pedidos de pagamento aprovados. O total desembolsado ultrapassa os 200 mil M€.',
      impact:
    ...
    },
    {
      ...
      description:
        'Com apenas 12 meses para o prazo final, os Estados-Membros intensificam a execução. A Comissão emite alertas formais a países com taxas de execução abaixo de 40%.',
