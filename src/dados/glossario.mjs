  ...
  terms: [
    {
      ...
      definition: 'Documento negociado entre um Estado-Membro e a Comissão Europeia que define a estratégia de utilização dos fundos estruturais e de investimento europeus para um determinado período de programação. Estabelece as prioridades de investimento, os objetivos temáticos e a repartição indicativa dos fundos.',
      category: 'Estrutura',
    ...
    },
    {
      ...
      definition: 'Processo de controlo externo e independente que verifica se os fundos do MRR foram utilizados de forma eficaz, eficiente e económica. É conduzida pelo Tribunal de Contas Europeu e pelos órgãos nacionais de controlo, podendo conduzir à suspensão ou recuperação de fundos.',
      category: 'Avaliação',
      example: 'O Tribunal de Contas Europeu auditou regularmente o progresso dos PRR, identificando lacunas na monitorização de marcos e metas em vários Estados-Membros.',
    ...
    },
    {
      ...
      definition: 'Análise sistemática dos efeitos — esperados ou verificados — das medidas incluídas no PRR sobre a economia, sociedade e ambiente. É obrigatória para determinadas categorias de intervenção e serve para justificar a pertinência e dimensão dos investimentos propostos.',
      category: 'Avaliação',
    ...
    },
    {
      ...
      definition: 'Pessoa singular ou coletiva, entidade pública ou privada, que recebe e utiliza diretamente os fundos atribuídos no âmbito do PRR para realizar projetos, reformas ou investimentos aprovados. Os beneficiários são responsáveis pelo cumprimento dos marcos e metas associados às suas intervenções.',
      category: 'Execução',
      example: 'O CP — Comboios de Portugal é um dos maiores beneficiários do PRR português, com verbas destinadas à modernização da frota ferroviária.',
    ...
    },
    {
      ...
      definition: 'Conjunto lógico de reformas e investimentos relacionados que contribuem para um objetivo específico dentro do PRR. Cada componente está associada a pelo menos um dos seis pilares do MRR e tem um orçamento, marcos e metas próprios. O PRR português está organizado em 20 componentes.',
      category: 'Estrutura',
      example: 'A Componente C01 — "Digitalização da Administração Pública" inclui medidas de modernização dos serviços públicos digitais, como o portal ePortugal.',
    ...
    },
    {
      ...
      definition: 'Instituição da UE composta pelos ministros de cada Estado-Membro. No contexto do MRR, é o Conselho que aprova formalmente, por via de decisão de execução, os PRR apresentados pelos Estados-Membros, com base na avaliação positiva da Comissão Europeia. Também autoriza os pedidos de pagamento.',
      category: 'Governação',
    ...
    },
    {
      ...
      definition: 'Conjunto de mecanismos — internos e externos — que garantem que os fundos do MRR são utilizados em conformidade com a lei e com os objetivos definidos. Inclui controlos de primeiro nível (entidade gestora), segundo nível (autoridade de auditoria) e auditorias externas (Tribunal de Contas Europeu, OLAF).',
      category: 'Governação',
    ...
    },
    {
      ...
      definition: 'Entidade responsável em Portugal pela coordenação global do PRR, incluindo a articulação com a Comissão Europeia, a preparação dos pedidos de pagamento e a monitorização do cumprimento dos marcos e metas. Funciona como ponto focal nacional do mecanismo.',
      category: 'Governação',
    },
    {
    ...
    },
    {
      ...
      definition: 'Conjunto de 14 indicadores definidos pela Comissão Europeia que todos os Estados-Membros devem reportar semestralmente, independentemente do conteúdo dos seus PRR. Cobrem áreas como energia renovável, eficiência energética, digitalização, educação, emprego e saúde, permitindo comparações entre países.',
      category: 'Indicadores',
      example: 'O Indicador Comum 2 mede a "Capacidade adicional de energia renovável instalada" em MW. Portugal reporta este valor semestralmente à Comissão.',
    ...
    },
    {
      ...
      definition: 'Indicador quantitativo e mensurável que define um valor-alvo a atingir (número de habitações renovadas, capacidade instalada em MW, percentagem de PMEs apoiadas, etc.) até uma data determinada. Como os marcos, o cumprimento das metas é verificado antes da aprovação de cada pedido de pagamento.',
      category: 'Execução',
      example: 'A Meta PT-T027 exige que 15.000 PMEs adotem tecnologias digitais até Q4 2025 como parte da Componente de Digitalização da Economia.',
    ...
    },
    {
      ...
      definition: 'O Regulamento do MRR exige que pelo menos 20% das despesas de cada PRR contribuam para a transformação digital. Cada medida é classificada com um coeficiente digital (0%, 40% ou 100%), e a soma ponderada deve atingir o limiar obrigatório. Este requisito apoia a agenda digital europeia.',
      category: 'Avaliação',
    ...
    },
    {
      ...
      definition: 'Organismo Europeu de Luta Antifraude, responsável por investigar fraudes, corrupção e irregularidades que afetam os interesses financeiros da UE. No âmbito do MRR, o OLAF tem poderes para investigar suspeitas de fraude ou conflito de interesses na utilização dos fundos do PRR, podendo recomendar recuperações e sanções.',
      category: 'Governação',
    ...
    },
    {
      ...
      definition: 'Documento formal apresentado por um Estado-Membro à Comissão Europeia solicitando o pagamento de uma tranche de fundos do MRR. Para ser aprovado, o pedido deve demonstrar o cumprimento satisfatório de todos os marcos e metas previstos para esse pagamento. Pode ser apresentado até duas vezes por ano.',
      category: 'Execução',
      example: 'Portugal apresentou o 1º Pedido de Pagamento em outubro de 2021, demonstrando o cumprimento de 38 marcos e metas, tendo recebido 1,2 mil M€ em janeiro de 2022.',
    ...
    },
    {
      ...
      definition: 'Segundo pilar do MRR, que agrupa as medidas de transformação digital da economia e da sociedade. Inclui investimentos em conectividade, competências digitais, digitalização das administrações públicas e das empresas. Exige que pelo menos 20% das despesas do PRR contribuam para a transformação digital.',
      category: 'Estrutura',
    ...
    },
    {
      ...
      definition: 'Primeiro pilar do MRR, que agrupa as medidas de descarbonização, eficiência energética, energias renováveis e proteção do ambiente. Exige que pelo menos 37% das despesas do PRR contribuam para os objetivos climáticos da UE, aplicando a metodologia de etiquetagem climática europeia.',
      category: 'Estrutura',
    ...
    },
    {
      ...
      definition: 'Documento elaborado por cada Estado-Membro que descreve as reformas estruturais e os investimentos prioritários que serão financiados pelo MRR. Deve ser coerente com os pilares do MRR, respeitar os limiares climático (37%) e digital (20%) e incluir marcos e metas mensuráveis. Em Portugal, o PRR vale 16,6 mil milhões de euros.',
      category: 'Estrutura',
      example: 'O PRR português — "Recuperar Portugal, Construindo o Futuro" — está organizado em 3 dimensões (Resiliência, Transição Climática, Transição Digital) e 20 componentes.',
    ...
    },
    {
      ...
      definition: 'Plataforma digital da Comissão Europeia que disponibiliza publicamente dados sobre o progresso de todos os PRR dos 27 Estados-Membros — incluindo marcos e metas cumpridos, montantes desembolsados e indicadores comuns reportados. É a principal fonte de dados para visualizações como as do Europium.',
      category: 'Avaliação',
