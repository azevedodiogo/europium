    ...
    <div class="mais-container">
      ...
      <div class="page-hero">
        ...
        <p class="page-hero__desc">
          ...
          Ferramentas adicionais do Europium para aprofundar a análise do
      ...
      <div class="mais-grid" v-scroll-animate.stagger>

        
        <!-- Cartões carregados do recurso `more`, vindo do json-server quando disponível. -->
        <MaisResourceCard
        ...
        >
          <template #icon>
            <svg v-if="resourceItem.icon === 'globe'" width="20" height="20" viewBox="0 0 20 20" fill="none" aria-hidden="true">
              ...
              <path d="M2.5 10h15M3.5 6.5h13M3.5 13.5h13" stroke="currentColor" stroke-width="1.1" stroke-linecap="round"/>
            </svg>
            <svg v-else-if="resourceItem.icon === 'document'" width="20" height="20" viewBox="0 0 20 20" fill="none" aria-hidden="true">
            ...
            <svg v-else-if="resourceItem.icon === 'timeline'" width="20" height="20" viewBox="0 0 20 20" fill="none" aria-hidden="true">
              ...
              <path d="M10 4.5h5a1.5 1.5 0 0 1 0 3h-5M10 9.5H5a1.5 1.5 0 0 0 0 3h5" stroke="currentColor" stroke-width="1.2" stroke-linecap="round"/>
            </svg>
          </template>
...
import MaisResourceCard from '@/componentes/mais/CartaoRecursoMais.vue'
// Pré-visualização decorativa da linha do tempo.
import MaisTimelinePreview from '@/componentes/mais/PrevisualizacaoLinhaTempoMais.vue'
...
.mais-page      { background: var(--color-bg-page); min-height: 100vh; padding-bottom: 80px; }

.mais-container { max-width: 1520px; margin: 0 auto; padding: 0 var(--container-padding); }
