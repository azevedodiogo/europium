<!-- Página dos disbursements com pagamentos e beneficiários. -->
<template>
  <div class="des-page">
...
import DisbursementsFilterBar from '@/components/disbursements/BarraFiltrosDesembolsos.vue'
import DisbursementsKpiCards from '@/components/disbursements/CartoesKpiDesembolsos.vue'
import DisbursementsPaymentsPanel from '@/components/disbursements/PainelPagamentosDesembolsos.vue'
import DisbursementsBeneficiariesPanel from '@/components/disbursements/PainelBeneficiariosDesembolsos.vue'
