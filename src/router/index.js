...
import PaginaMarcosMetas from '@/pages/PaginaMarcosMetas.vue'
import PaginaIndicadores from '@/pages/PaginaIndicadores.vue'
import PaginaDesembolsos from '@/pages/PaginaDesembolsos.vue'
import PaginaCompararPaises from '@/pages/PaginaCompararPaises.vue'
import PaginaMapa from '@/pages/PaginaMapa.vue'
import PaginaMais from '@/pages/PaginaMais.vue'
import PaginaGlossario from '@/pages/PaginaGlossario.vue'
import PaginaLinhaTempo from '@/pages/PaginaLinhaTempo.vue'
