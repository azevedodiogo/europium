...
<template>
  ...
  <header class="header">
    <!-- Bloco alinhado com a largura do site. -->
    <div class="header__inner">
      ...
      <nav class="header__nav" role="navigation" aria-label="Navegação principal" ref="navEl">
        ...
        <div v-if="pillStyle" class="header__pill" :style="pillStyle" aria-hidden="true" />
        ...
        <RouterLink
          ...
          :class="{ 'header__nav-link--active': isActive(link.to), 'header__nav-link--more': link.to === '/mais' }"
      ...
      <div class="header__actions">
        ...
        >
          ...
          <IconePublico v-if="!isDark" src="/icons/moon.svg" :size="15" />
          <!-- Sol quando o tema atual é escuro. -->
          <IconePublico v-else src="/icons/sun.svg" :size="15" />
        </button>
      </div>
    </div>
  </header>
...
// Referência à área da navegação.
