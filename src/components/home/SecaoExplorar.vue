...
<template>
  ...
  <section class="explore" aria-labelledby="explore-title">
    ...
    <header class="explore__header">
      ...
      <p class="explore__subtitle">Navegue pelas diferentes áreas de informação do Europium.</p>
    </header>
    ...
    <div class="explore__grid" role="list">
      ...
      <RouterLink v-for="link in exploreLinks" :key="link.id" :to="link.route" class="explore__card" role="listitem">
