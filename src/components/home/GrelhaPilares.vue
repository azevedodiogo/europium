  ...
  <section class="pillars" aria-labelledby="pillars-title">
    <div class="pillars__container">
      ...
      <header class="pillars__header">
        <h2 id="pillars-title" class="pillars__title">Seis Pilares do Mecanismo de Recuperação e Resiliência</h2>
      ...
      <div class="pillars__grid" role="list">
        ...
        <article v-for="pillar in pillars" :key="pillar.id" class="pillars__card" role="listitem">
...
// Ícone genérico que converte o nome do dado no SVG certo, ou seja, no desenho vetorial usado no cartão.
import AppIcon from '@/components/app/IconeApp.vue'
const store = useDashboardStore()
// Mantém a lista reativa caso os dados venham a ser substituídos pelo json-server, a API local.
